...
session.cookies = cookiejar.LWPCookieJar(filename="cookie.txt")  # cookie存储文件，
# 提取保存的cookie
try:
...
def is_login():
    ...
    if response.status_code != 200:
        zhihu_login("+8615829779349", "qq123456789")
    else:
        print("你已经登陆了")
...
def get_xsrf_dc0():
    ...
    URL_ROOT = 'https://www.zhihu.com/signup'
    ...
    cookie = cookiejar.LWPCookieJar(cookie_filename)
    ...
    return cookie["_xsrf"], cookie["d_c0"]
